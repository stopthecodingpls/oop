...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initLogin() {
        ...
        ImageIcon logoIcon = new ImageIcon(getClass().getResource("/com/raven/icon/puplogo.png"));
        JLabel logoLabel = new JLabel(logoIcon);
        int logoWidth = 100; 
        int logoHeight = -1;
        Image image = logoIcon.getImage().getScaledInstance(logoWidth, logoHeight, Image.SCALE_SMOOTH);
        logoIcon = new ImageIcon(image);
        logoLabel.setIcon(logoIcon);
        logoLabel.setHorizontalAlignment(JLabel.CENTER);
        login.add(logoLabel, "align center, wrap");
